...
import { Loader2, Eye, Clock, Key } from "lucide-react"
      ...
      <div className="w-full max-w-md">
        <Card>
                ...
                <div className="space-y-3 pl-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => setIncludePasswordInLink(checked === true)}
                    />
          ...
          <CardFooter className="flex justify-between">
            ...
            <Button onClick={handleSaveNote} disabled={!note.trim() || isSaving || (usePassword && !password)}>
              {isSaving ? (
                <>
