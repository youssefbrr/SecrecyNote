        ...
        <div className="w-full max-w-md">
          <Card>
            <CardHeader>
              ...
              <CardDescription>This note has expired and is no longer available.</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col items-center justify-center py-8 text-center">
                <AlertTriangle className="h-8 w-8 text-destructive" />
                <p className="mt-4 font-medium text-destructive">This note has expired.</p>
                <p className="mt-2 text-sm text-muted-foreground">
                  For security reasons, notes are automatically deleted after their expiration time.
                </p>
              </div>
            </CardContent>
            <CardFooter>
